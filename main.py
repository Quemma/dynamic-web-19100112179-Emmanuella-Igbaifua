...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:postgres@localhost:5436/flask'
app.config[
    'SQLALCHEMY_TRACK_MODIFICATIONS'] = False  # this is added to avoid the warning message FSADeprecationWarning: SQLALCHEMY_TRACK_MODIFICATIONS adds significant overhead and will be disabled by default in the future.  Set it to True or False to suppress this warning.
...
def process_login():
    ...
    if (authenticateUser(email, password)):
        ...
        session['userroles'] = [
            'admin']  # just hardcoding a list of roles for the sake of illustration. This should be read from database.
